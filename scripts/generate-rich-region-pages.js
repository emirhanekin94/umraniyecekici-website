...
const regionsData = [
  // 1. Ümraniye & Mahalleleri
  {
    ...
    photo1: '../images/otomobil-cekici-1.webp',
    photoCaption1: 'Ümraniye Alemdağ Caddesi ve Santral mevkiinde binek aracın sıfır temas kayar kasa platforma yüklenmesi.',
    photo2: '../images/luks-arac-cekici.webp',
    photoCaption2: 'Santral Meydanı ve Çarşı aksında alçak şaseli spor aracın hasarsız hidrolik rampa ile kaskolu transferi.',
  ...
  },
  {
    ...
    photo1: '../images/otomobil-cekici-2.webp',
    photoCaption1: 'Aşağı ve Yukarı Dudullu kavşağında mekanik arızalı aracın hidrolik platform ile güvenli transferi.',
    photo2: '../images/ticari-cekici-1.webp',
    photoCaption2: 'Dudullu OSB ve Tavukçuyolu caddesinde hafif ticari araçların garantili nakliyesi.',
  ...
  },
  {
    ...
    photo1: '../images/otomobil-cekici-3.webp',
    photoCaption1: 'Tepeüstü Köprülü Kavşağı ve IKEA çevresinde arıza yapan lüks SUV aracın hasarsız nakli.',
    photo2: '../images/suv-cekici-1.webp',
    photoCaption2: 'Meydan AVM ve Buyaka kapalı otoparkından alçak şase uyumlu vinçli çekiciyle araç tahliyesi.',
  ...
  },
  {
    ...
    photo1: '../images/luks-arac-cekici-1.webp',
    photoCaption1: 'Şerifali Finanskent bölgesinde kapalı otoparktan VIP lüks aracın aparatlı transferi.',
    photo2: '../images/otomobil-cekici-4.webp',
    photoCaption2: 'Turgut Özal Bulvarı ve Barbaros caddesinde kaskolu kayar kasa çekici operasyonu.',
  ...
  },
  {
    ...
    photo1: '../images/otomobil-cekici-5.webp',
    photoCaption1: 'Atakent ve Armağanevler caddelerinde arıza yapan otomatik vites aracın kaskolu taşınması.',
    photo2: '../images/aku-takviye.webp',
    photoCaption2: 'Mithatpaşa Caddesi ve Çamlık Mahallesi sitelerinde yerinde profesyonel 12V akü takviyesi.',
  ...
  },
  {
    ...
    photo1: '../images/kazali-arac-cekici-1.webp',
    photoCaption1: 'Çakmak Köprüsü üzerinde hasarlı aracın vinçli kurtarıcıyla sıfır hasarla emniyete alınması.',
    photo2: '../images/otomobil-cekici.webp',
    photoCaption2: 'Saray Mahallesi ve Küçüksu Caddesi aksında kayar kasa çekici ile garantili transfer.',
  ...
  },
  {
    ...
    photo1: '../images/suv-cekici-2.webp',
    photoCaption1: 'Ihlamurkuyu ve Cemil Meriç caddelerinde SUV aracın aparatlı güvenli transferi.',
    photo2: '../images/lastik-tamir.webp',
    photoCaption2: 'İstiklal Caddesi ve FSM Mahallesi civarında mobil lastik tamiri ve stepne değişimi.',
  ...
  },
  {
    ...
    photo1: '../images/suv-cekici-3.webp',
    photoCaption1: 'Hekimbaşı ve Küçüksu virajlarında çamura kayan 4x4 SUV aracın vinçle kurtarılması.',
    photo2: '../images/otomobil-cekici-1.webp',
    photoCaption2: 'Dumlupınar ve Kazım Karabekir mahallesinde kayar platform ile sıfır hasarlı taşıma.',
  ...
  },
  {
    ...
    categoryName: 'Ümraniye & Mahalleleri',
    eta: '10 - 15 Dk',
    title: 'Esenşehir Oto Çekici 7/24 | KADOSAN Sanayi & Esenkent Kurtarma - 0544 138 07 34',
    metaDesc: 'Esenşehir Mahallesi, Esenkent, KADOSAN Oto Sanayi Sitesi ve Barajyolu Caddesi üzerinde 7/24 nöbetçi oto çekici ve kurtarma. 0544 138 07 34.',
    keywords: 'esenşehir oto çekici, kadosan çekici, esenkent çekici, barajyolu caddesi çekici, ümraniye esenşehir yol yardım, kadosan oto sanayi çekici',
    mainRoads: 'KADOSAN Sanayi Yolu, Baraj Yolu Caddesi, NATO Yolu Caddesi, Kürkçüler Caddesi',
    industrialPoints: 'KADOSAN Oto Sanayi Sitesi, Esenşehir İmalatçılar Sanayi, DES Sanayi Çıkışı',
    photo1: '../images/kamyonet-cekici-1.webp',
    photoCaption1: 'KADOSAN Sanayi Sitesi girişinde yürümeyen hafif ticari kamyonetin yüklenişi.',
    photo2: '../images/ticari-cekici-2.webp',
    photoCaption2: 'Esenşehir ve Barajyolu caddesi üzerinde hidrolik kayar kasa çekici transferi.',
    neighborSlugs: ['imes-modoko-oto-cekici', 'dudullu-oto-cekici', 'sancaktepe-oto-cekici', 'sarigazi-oto-cekici', 'serifali-oto-cekici', 'tem-otoyolu-oto-cekici'],
    faqs: [
      { q: "KADOSAN Sanayi Sitesi içine veya dışına araç çekiyor musunuz?", a: "Evet, sanayi içerisindeki tüm dükkanlara veya servisinizden KADOSAN ustalarına nakil yapıyoruz." },
      { q: "Esenşehir ve Esenkent bölgesine kaç dakikada varırsınız?", a: "Bölgedeki nöbetçi aracımız ortalama 10-15 dakikada yanınızda olur." },
      { q: "Ticari araç ve kamyonet çekimi yapılabilir mi?", a: "Yüksek tonajlı taşıma kapasitesine sahip araçlarımızla hafif ticari filoları çekiyoruz." },
      { q: "Fiyatlar KADOSAN esnafına uygun mudur?", a: "Bölge esnafına ve araç sahiplerine en ekonomik sabit fiyatları sunuyoruz." },
      { q: "Akü takviyesi var mı?", a: "Evet, yerinde takviye ve çalıştırma desteği sunuyoruz." }
    ]
  },
  {
    slug: 'imes-modoko-oto-cekici',
    name: 'İMES & MODOKO',
    fullName: 'İMES Sanayi Sitesi, MODOKO & KEYAP',
    category: 'umraniye',
    categoryName: 'Ümraniye & Mahalleleri',
    eta: '10 - 15 Dk',
    title: 'İMES & MODOKO Oto Çekici 7/24 | DES Sanayi & KEYAP Kurtarma - 0544 138 07 34',
    metaDesc: 'İMES Sanayi Sitesi, MODOKO Mobilyacılar Sitesi, DES Sanayi ve KEYAP çevresinde 7/24 profesyonel oto kurtarma, ağır ticari ve binek oto çekici. 0544 138 07 34.',
    keywords: 'imes oto çekici, modoko çekici, des sanayi çekici, keyap çekici, dudullu osb çekici, ümraniye sanayi oto çekici',
    mainRoads: 'MODOKO Caddesi, İMES A Kapısı, DES Sanayi Bulvarı, Dudullu OSB 1. Cadde',
    industrialPoints: 'İMES Sanayi Sitesi, MODOKO, DES Sanayi, KEYAP Ticaret Merkezi',
    photo1: '../images/ticari-cekici-3.webp',
    photoCaption1: 'İMES Sanayi Sitesi ve DES Bulvarı aksında ticari panelvanın güvenli nakliyesi.',
    photo2: '../images/kamyonet-cekici-2.webp',
    photoCaption2: 'MODOKO ve KEYAP mobilyacılar bölgesinde kayar platform ile hasarsız yükleme.',
    neighborSlugs: ['dudullu-oto-cekici', 'esensehir-oto-cekici', 'serifali-oto-cekici', 'atasehir-oto-cekici', 'tem-otoyolu-oto-cekici', 'umraniye-oto-cekici'],
    faqs: [
      { q: "İMES ve DES sanayi sitelerinde dükkan önüne araç teslimi yapıyor musunuz?", a: "Evet, doğrudan ustanızın lifte alacağı şekilde hassas indirme yapıyoruz." },
      { q: "MODOKO ve KEYAP civarında arıza durumunda ne kadar sürede gelirsiniz?", a: "Bölgede konuşlu çekicimiz 10 dakikada yanınızdadır." },
      { q: "Ağır ticari veya yüklü panelvan taşıyabiliyor musunuz?", a: "Yüksek istiap haddine sahip platformlarımızla güvenli taşıma sağlıyoruz." },
      { q: "Sanayiden başka bir ilçeye nakil ücreti nedir?", a: "Mesafe bazlı önceden konuşulan şeffaf sabit fiyat uygulanır." },
      { q: "Kurumsal fatura kesiliyor mu?", a: "Şirket ve şahıs firmalarına KDV'li kurumsal fatura kesiyoruz." }
    ]
  },
  ...
  // 2. Komşu İlçeler
  {
    ...
    name: 'Çekmeköy',
    fullName: 'Çekmeköy Merkez, Madenler & Mimar Sinan',
    category: 'komsu',
    categoryName: 'Komşu İlçeler',
    eta: '10 - 15 Dk',
    title: 'Çekmeköy Oto Çekici 7/24 | Madenler & Mimar Sinan Kurtarma - 0544 138 07 34',
    metaDesc: 'Çekmeköy Merkez, Madenler, Mimar Sinan, Şahinbey Caddesi ve Çamlık civarında 7/24 en yakın acil oto çekici ve yol yardım. 0544 138 07 34.',
    keywords: 'çekmeköy oto çekici, madenler çekici, mimar sinan çekici, şahinbey caddesi çekici, çekmeköy yol yardım, çekmeköy oto kurtarma',
    mainRoads: 'Şahinbey Caddesi, Madenler Meydanı, Çekmeköy Metro Çıkışı, Mimar Sinan Caddesi, Barış Yolu Caddesi',
    industrialPoints: 'Çekmeköy Çarşı, Madenler Köprülü Kavşağı, Taşdelen Bağlantı Koridoru',
    photo1: '../images/suv-cekici.webp',
    photoCaption1: 'Çekmeköy Madenler ve Şile Otoyolu sapağında SUV aracın hidrolik kasaya alınması.',
    photo2: '../images/otomobil-cekici-2.webp',
    photoCaption2: 'Şahinbey Caddesi ve Mimar Sinan mahallesinde binek otomobilin kaskolu transferi.',
    neighborSlugs: ['tasdelen-oto-cekici', 'tepeustu-oto-cekici', 'dudullu-oto-cekici', 'sile-otoyolu-oto-cekici', 'sancaktepe-oto-cekici', 'umraniye-oto-cekici'],
    faqs: [
      { q: "Çekmeköy Madenler ve merkez mahallelerine çekici kaç dakikada varır?", a: "Madenler nöbet noktamızdan 10 ila 15 dakika içinde adresinize ulaşıyoruz." },
      { q: "Şile Otoyolu Çekmeköy çıkışında arıza olursa ne yapmalıyım?", a: "Hemen 0544 138 07 34'ü arayın, reflektörünüzü yerleştirin, ekibimiz derhal yola çıkar." },
      { q: "Çekmeköy'den Ümraniye Oto Sanayi'ye çekici ücreti ne kadardır?", a: "En uygun sabit fiyat garantisi veriyoruz, mesafe bazlı net teklif sunuyoruz." },
      { q: "Akü takviyesi ve lastik patlamasında yardım var mı?", a: "Evet, yerinde takviye ve stepne değişimi 7/24 sağlanmaktadır." },
      { q: "Hafta sonu hizmetiniz açık mı?", a: "Evet, 7 gün 24 saat kesintisiz hizmet veriyoruz." }
    ]
  },
  {
    ...
    categoryName: 'Komşu İlçeler',
    eta: '10 - 15 Dk',
    title: 'Taşdelen Oto Çekici 7/24 | Alemdağ & Şile Otoyolu Kurtarma - 0544 138 07 34',
    metaDesc: 'Taşdelen, Alemdağ, Güngören, Nişantepe ve Taşdelen Tünelleri civarında 7/24 oto çekici, kurtarıcı ve akü takviye. 0544 138 07 34.',
    keywords: 'taşdelen oto çekici, alemdağ çekici, nişantepe çekici, taşdelen şile yolu çekici, çekmeköy taşdelen kurtarma',
    mainRoads: 'Turgut Özal Bulvarı Taşdelen, Şile Otoyolu Taşdelen Sapağı, Alemdağ Caddesi, Nişantepe Yolu',
    industrialPoints: 'Taşdelen Sanayi Esnafı, Alemdağ Orman Çıkışı, Özyeğin Üniversitesi Güzergahı',
    photo1: '../images/otomobil-cekici-3.webp',
    photoCaption1: 'Taşdelen Tünelleri çıkışında mekanik arızalı binek aracın kayar platforma alınması.',
    photo2: '../images/suv-cekici-1.webp',
    photoCaption2: 'Alemdağ ve Nişantepe virajlarında 4x4 arazi aracının emniyetle yüklenişi.',
    neighborSlugs: ['cekmekoy-oto-cekici', 'sile-otoyolu-oto-cekici', 'kuzey-marmara-otoyolu-oto-cekici', 'sancaktepe-oto-cekici', 'dudullu-oto-cekici', 'tepeustu-oto-cekici'],
    faqs: [
      { q: "Taşdelen Tünelleri çıkışında arıza kurtarması yapıyor musunuz?", a: "Evet, otoyol güvenlik protokolleriyle hızla aracınızı güvenli alana alıyoruz." },
      { q: "Alemdağ ve Nişantepe civarına çekici kaç dakikada gelir?", a: "Ortalama 10-15 dakika içinde ulaşıyoruz." },
      { q: "Özyeğin Üniversitesi kampüs bölgesine hizmetiniz var mı?", a: "Evet, kampüs ve çevre yollarında 7/24 çekici desteği sağlıyoruz." },
      { q: "Sabit fiyat garantisi veriyor musunuz?", a: "Evet, telefonda verdiğimiz net fiyat haricinde sürpriz ücret talep edilmez." },
      { q: "Motosiklet taşıyor musunuz?", a: "Özel teker kilitleme sehpalı araçlarımızla motosiklet taşıyoruz." }
    ]
  },
  {
    slug: 'atasehir-oto-cekici',
    name: 'Ataşehir',
    fullName: 'Ataşehir Merkez, Barbaros & Finans Merkezi',
    category: 'komsu',
    categoryName: 'Komşu İlçeler',
    eta: '10 - 15 Dk',
    title: 'Ataşehir Oto Çekici 7/24 | Finans Merkezi & Barbaros Kurtarma - 0544 138 07 34',
    metaDesc: 'Ataşehir Merkez, Barbaros, İstanbul Finans Merkezi, İçerenköy, Küçükbakkalköy ve Batı Ataşehir civarında 7/24 en yakın oto çekici. 0544 138 07 34.',
    keywords: 'ataşehir oto çekici, barbaros mahallesi çekici, finans merkezi çekici, batı ataşehir çekici, ataşehir oto kurtarma, ataşehir yol yardım',
    mainRoads: 'Ataşehir Bulvarı, Halk Caddesi, Barbaros Bulvarı, Finans Merkezi Yolu, TEM Ataşehir Katılımı',
    industrialPoints: 'İstanbul Finans Merkezi, Palladium AVM Çevresi, Brandium Bölgesi, Ataşehir Siteleri',
    photo1: '../images/luks-arac-cekici-2.webp',
    photoCaption1: 'İstanbul Finans Merkezi ve Barbaros Bulvarı lüks sedan aracın hassas nakli.',
    photo2: '../images/otomobil-cekici-4.webp',
    photoCaption2: 'Batı Ataşehir ve Brandium çevresinde kaskolu kayar kasa transferi.',
    neighborSlugs: ['icerenkoy-oto-cekici', 'serifali-oto-cekici', 'dudullu-oto-cekici', 'kadikoy-goztepe-oto-cekici', 'umraniye-oto-cekici', 'tem-otoyolu-oto-cekici'],
    faqs: [
      { q: "Ataşehir Finans Merkezi ve plazalar bölgesine çekici ne kadar sürede varır?", a: "Finans Merkezi civarında bekleyen nöbetçi kurtarıcımız 10-15 dakikada yanınızda olur." },
      { q: "Site ve plaza kapalı otoparklarından araç çekebiliyor musunuz?", a: "Özel basık tavanlı ve açılı kayar platformlarımızla kapalı otoparklardan rahatça araç çıkarıyoruz." },
      { q: "Lüks ve elektrikli araçlar için özel ekipmanınız var mı?", a: "Tekerlek kaydırma bebekleri ile diferansiyel ve el frenine zarar vermeden güvenle yüklüyoruz." },
      { q: "Ataşehir'den Bostancı Sanayi Sitesi'ne çekici ücreti ne kadar?", a: "Ekonomik ve sabit fiyat politikamızla en uygun taşımayı sağlıyoruz." },
      { q: "Gece çağrılarına yanıt veriyor musunuz?", a: "Haftanın her günü, 24 saat nöbetçi operatörlerimiz çağrınızı karşılar." }
    ]
  },
  {
    slug: 'icerenkoy-oto-cekici',
    name: 'İçerenköy',
    fullName: 'İçerenköy, Küçükbakkalköy & Kozyatağı',
    category: 'komsu',
    categoryName: 'Komşu İlçeler',
    eta: '10 - 15 Dk',
    title: 'İçerenköy Oto Çekici 7/24 | Küçükbakkalköy & Bostancı Çekici - 0544 138 07 34',
    metaDesc: 'İçerenköy, Küçükbakkalköy, Kayışdağı, Hal Yolu ve Bostancı Sanayi aksında 7/24 acil oto çekici ve yol yardım. 0544 138 07 34.',
    keywords: 'içerenköy oto çekici, küçükbakkalköy çekici, içerenköy hal yolu çekici, bostancı sanayi çekici, kayışdağı çekici',
    mainRoads: 'İçerenköy Hal Yolu, Kayışdağı Caddesi, Prof. Dr. Necmettin Erbakan Caddesi, D-100 Bağlantısı',
    industrialPoints: 'Bostancı Oto Sanayi Sitesi Yanı, İçerenköy Hal Tesisleri, CarrefourSA Çevresi',
    photo1: '../images/otomobil-cekici-5.webp',
    photoCaption1: 'İçerenköy Hal Yolu ve Carrefour civarında arıza yapan aracın süratle emniyete alınması.',
    photo2: '../images/aku-takviye.webp',
    photoCaption2: 'Küçükbakkalköy ve Kayışdağı aksında yerinde akü booster takviyesi ve çalıştırma.',
    neighborSlugs: ['atasehir-oto-cekici', 'kadikoy-goztepe-oto-cekici', 'd100-e5-oto-cekici', 'serifali-oto-cekici', 'esensehir-oto-cekici', 'umraniye-oto-cekici'],
    faqs: [
      { q: "Bostancı Oto Sanayi Sitesi'ne yakın mısınız?", a: "Evet, İçerenköy ve Bostancı Sanayi sınırında araçlarımız hazır beklemektedir; varış 10 dakikadır." },
      { q: "Hal Yolu üzerinde kaza yapan aracı nasıl çekiyorsunuz?", a: "Trafik güvenliğini sağlayıp vinçli kayar kasamızla yolu hızla açıyoruz." },
      { q: "Kayışdağı yokuşlarında kalan araçlara takviye var mı?", a: "Mobil akü takviye ve yol yardım ekibimiz yerinde müdahale eder." },
      { q: "Taşıma kaskosu geçerli mi?", a: "Tüm operasyonlarımız kurumsal taşıyıcı kaskosu altındadır." },
      { q: "Fiyat bilgisi nasıl alınır?", a: "0544 138 07 34'ü arayarak rotanızı söylemeniz yeterlidir." }
    ]
  },
  {
    slug: 'sancaktepe-oto-cekici',
    name: 'Sancaktepe',
    fullName: 'Sancaktepe, Samandıra & Sarıgazi',
    category: 'komsu',
    categoryName: 'Komşu İlçeler',
    eta: '10 - 15 Dk',
    title: 'Sancaktepe Oto Çekici 7/24 | Samandıra & Sarıgazi Kurtarma - 0544 138 07 34',
    metaDesc: 'Sancaktepe Merkez, Samandıra, Sarıgazi, Yenidoğan ve TEM Samandıra Gişeleri civarında 7/24 hızlı oto çekici ve kurtarıcı. 0544 138 07 34.',
    keywords: 'sancaktepe oto çekici, samandıra çekici, sarıgazi çekici, sancaktepe yol yardım, samandıra gişeler çekici',
    mainRoads: 'Osmangazi Caddesi, Samandıra Gişeler Bağlantısı, Atatürk Caddesi, Baraj Yolu, Eyüp Sultan Caddesi',
    industrialPoints: 'Samandıra Sanayi Sitesi, Sancaktepe Şehir Hastanesi Aksı, Rings AVM Çevresi',
    photo1: '../images/minibus-cekici.webp',
    photoCaption1: 'Samandıra Gişeleri ve Sancaktepe Şehir Hastanesi civarında minibüs nakli.',
    photo2: '../images/kamyonet-cekici.webp',
    photoCaption2: 'Yenidoğan ve Paşaköy bağlantısında ticari kamyonetin hidrolik platformla taşınması.',
  ...
  },
  {
    ...
    photo1: '../images/ticari-cekici-4.webp',
    photoCaption1: 'Sarıgazi Meydanı ve Demokrasi Caddesi üzerinde ticari aracın kaskolu çekimi.',
    photo2: '../images/otomobil-cekici-1.webp',
    photoCaption2: 'İnönü Mahallesi ve Meclis Mahallesi dar sokaklarında hasarsız kayar kasa kurtarma.',
  ...
  },
  {
    ...
    photo1: '../images/motorsiklet-cekici-1.webp',
    photoCaption1: 'Çamlıca ve Libadiye caddesinde arızalanan motosikletin özel gergi askısıyla taşınması.',
    photo2: '../images/otomobil-cekici-2.webp',
    photoCaption2: 'Bulgurlu ve Kısıklı caddelerinde arıza yapan sedan otomobilin sıfır temas nakli.',
  ...
  },
  {
    ...
    photo1: '../images/luks-arac-cekici-3.webp',
    photoCaption1: '15 Temmuz Şehitler Köprüsü Altunizade ayrımında lüks otomobilin güvenli tahliyesi.',
    photo2: '../images/otomobil-cekici.webp',
    photoCaption2: 'Acıbadem ve Koşuyolu caddelerinde hidrolik kayar kasa platform ile sıfır temas nakil.',
  ...
  },
  {
    ...
    photo1: '../images/ozel-cekici.webp',
    photoCaption1: 'FSM Köprüsü Kavacık çıkışında mekanik kilitli aracın tekerlek aparatı ile hasarsız yüklenmesi.',
    photo2: '../images/suv-cekici-2.webp',
    photoCaption2: 'Rüzgarlıbahçe ve Çavuşbaşı virajlı yollarında 4x4 SUV aracın vinçli transferi.',
  ...
  },
  {
    ...
    photo1: '../images/e-5-cekici.webp',
    photoCaption1: 'Göztepe Köprüsü üzerinde arıza yapan aracın E-5 trafiğini aksatmadan hızlı tahliyesi.',
    photo2: '../images/motorsiklet-cekici-2.webp',
    photoCaption2: 'Kadıköy ve Kozyatağı caddelerinde motosiklet ve scooter güvenli kafes sabitleme.',
  ...
  // 3. Otoyollar & Gişeler
  {
    ...
    photo1: '../images/kazali-arac-cekici-2.webp',
    photoCaption1: 'TEM Ümraniye Gişeleri yakınında emniyet şeridinde kalan aracın tepe lambalı koruma ile yüklenişi.',
    photo2: '../images/otoyol-yardim-cekici.webp',
    photoCaption2: 'Çamlıca Gişeler ve FSM bağlantısında yüksek hızlı otoyol kurtarma platformu.',
  ...
  },
  {
    ...
    photo1: '../images/suv-cekici-3.webp',
    photoCaption1: 'Şile Otoyolu Ömerli virajında kaygan zeminde kalan 4x4 SUV aracın güvenli tahliyesi.',
    photo2: '../images/arac-cekici.webp',
    photoCaption2: 'Taşdelen ve Alemdağ tünel girişlerinde çakar lambalı acil kurtarıcı koridoru.',
  ...
  },
  {
    ...
    photo1: '../images/arac-cekici.webp',
    photoCaption1: 'Kuzey Marmara Otoyolu Reşadiye gişelerinde yüksek hızlı otoyol emniyetli kurtarma operasyonu.',
    photo2: '../images/kazali-arac-cekici.webp',
    photoCaption2: 'Paşaköy Kavşağı ve Hüseyinli tünellerinde vinçli platform ile hasarsız araç yükleme.',
  ...
  },
  {
    ...
    categoryName: 'Otoyollar & Gişeler',
    eta: '10 - 15 Dk',
    title: 'D-100 E-5 Oto Çekici 7/24 | Göztepe - Kozyatağı - Bostancı - 0544 138 07 34',
    metaDesc: 'D-100 E-5 Karayolu Göztepe Köprüsü, Yenisahra, Kozyatağı Kavşağı ve Bostancı Sanayi güzergahında 7/24 acil oto çekici. 0544 138 07 34.',
    keywords: 'd100 e5 oto çekici, e5 çekici, göztepe köprüsü çekici, kozyatağı e5 çekici, yenisahra çekici, e5 yol yardım',
    mainRoads: 'D-100 Karayolu, Göztepe Köprüsü, Yenisahra Kavşağı, Kozyatağı Köprüsü, Bostancı Köprüsü Yan Yollar',
    industrialPoints: 'Bostancı Sanayi Çıkışı, Kozyatağı Metro Meydanı, Medeniyet Üniversitesi Çevresi',
    photo1: '../images/e-5-cekici.webp',
    photoCaption1: 'D-100 E-5 Göztepe mevkiinde yoğun trafikte emniyet şeridi güvenliği ile hızlı tahliye.',
    photo2: '../images/otomobil-cekici-3.webp',
    photoCaption2: 'Yenisahra ve Kozyatağı köprüsünde mekanik arızalı aracın kayar platforma alınışı.',
    ...
    faqs: [
      { q: "E-5 üzerinde arıza yaptığımda trafiği tehlikeye atmadan nasıl çekim yapılır?", a: "Tepe çakar lambalarımız ve reflektörlerle emniyet alanı oluşturup 3 dakika içinde aracı platforma alıyoruz." },
      { q: "Göztepe veya Yenisahra Köprüsü'nde çekici bekleme süresi nedir?", a: "E-5 üzerindeki nöbetçi filomuz 10 dakika içinde yanınızda olur." },
      { q: "Bostancı Oto Sanayi Sitesi'ne araç nakli yapıyor musunuz?", a: "Evet, doğrudan Bostancı Sanayi veya dilediğiniz özel/yetkili servise teslim ediyoruz." },
      { q: "Lastik patlaması ve akü takviyesi E-5 emniyet şeridinde yapılabilir mi?", a: "Trafik güvenliğini sağlayarak yerinde lastik ve akü desteği veriyoruz." },
      { q: "Ücret bilgisi nasıl alınır?", a: "7/24 arayabileceğiniz 0544 138 07 34 hattımızdan anında net fiyat alabilirsiniz." }
    ]
  }
];
...
function generateCompleteRegionPage(r) {
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Ana Sayfa",
        "item": "https://umraniyeyolyardim.com/"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "Hizmet Bölgeleri",
        "item": "https://umraniyeyolyardim.com/bolgeler/index.html"
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": r.name,
        "item": `https://umraniyeyolyardim.com/bolgeler/${r.slug}.html`
      }
    ]
  };
  ...
  const autoRepairSchema = {
    "@context": "https://schema.org",
    "@type": "AutoRepair",
    "name": `Ümraniye Yol Yardım - ${r.fullName} Oto Çekici ve Kurtarma`,
    "telephone": "+905441380734",
    "url": `https://umraniyeyolyardim.com/bolgeler/${r.slug}.html`,
    "image": `https://umraniyeyolyardim.com/${r.photo1.replace('../', '')}`,
    "priceRange": "₺₺",
    "address": {
      "@type": "PostalAddress",
...
<head>
  ...
  ${JSON.stringify(autoRepairSchema, null, 2)}
  </script>
...
<body>
  ...
  <main class="section">
    <div class="container" style="max-width: 1060px;">
      ...
      <article class="region-feature-box">
        ...
        <!-- 4 Adımlı Kurtarma Süreci -->
        <h3 style="font-size: 1.35rem; color: var(--secondary); margin: 35px 0 15px;">${r.name} Çekici Süreci Nasıl İşler?</h3>
        <div class="process-steps-grid">
          <div class="process-step-card">
            <div class="process-step-num">1</div>
            <div class="process-step-title">İhbar & Konum</div>
            <div class="process-step-desc">Telefonla arayın veya WhatsApp'tan konum atın, saniyeler içinde sabit net fiyat verelim.</div>
          </div>
          <div class="process-step-card">
            <div class="process-step-num">2</div>
            <div class="process-step-title">${r.eta} Varış</div>
            <div class="process-step-desc">${r.name} nöbetçi çekicimiz en kısa trafik rotası üzerinden derhal yola çıksın.</div>
          </div>
          <div class="process-step-card">
            <div class="process-step-num">3</div>
            <div class="process-step-title">Güvenli Yükleme</div>
            <div class="process-step-desc">Reflektör güvenlik koridoru açılır, araç kayar kasaya sıfır temasla kaskolu sabitlenir.</div>
          </div>
          <div class="process-step-card">
        ...
        <h3 style="font-size: 1.35rem; color: var(--secondary); margin: 35px 0 12px;">${r.name} Bölgesinde Taşıdığımız Araç Tipleri</h3>
        ...
        <!-- Bölge Gerçek Saha Fotoğrafları (2 Fotoğraflı Operasyon Vitrini) -->
        <div class="region-photo-showcase">
          <div class="region-photo-card">
            <div class="photo-box">
              <img src="${r.photo1}" alt="${r.name} oto çekici ve kurtarma saha operasyonu" title="${r.name} Çekici Operasyonu" loading="lazy" width="860" height="400">
              <span class="photo-badge">📸 ${r.name} Saha Operasyonu</span>
            </div>
            <div style="padding: 14px 16px; background: var(--bg-light); border-top: 1px solid var(--border-color);">
              <strong style="color: var(--secondary); font-size: 0.92rem;">Saha Operasyon Kaydı:</strong>
              <span style="color: var(--text-muted); font-size: 0.85rem; margin-left: 6px;">${r.photoCaption1}</span>
            </div>
          </div>

          <div class="region-photo-card">
            <div class="photo-box">
              <img src="${r.photo2}" alt="${r.name} kaskolu hasarsız araç yükleme ve yol yardım" title="${r.name} Güvenli Taşıma Ekipmanı" loading="lazy" width="860" height="400">
              <span class="photo-badge">🛡️ Kaskolu & Aparatlı Taşıma</span>
            </div>
            <div style="padding: 14px 16px; background: var(--bg-light); border-top: 1px solid var(--border-color);">
              <strong style="color: var(--secondary); font-size: 0.92rem;">Donanım Standardı:</strong>
              <span style="color: var(--text-muted); font-size: 0.85rem; margin-left: 6px;">${r.photoCaption2}</span>
            </div>
          </div>
        </div>
      ...
      <!-- Neden Biz? (Bölgesel 3 Güvence Kartı) - Komşu Lokasyonların Üstünde -->
      <div style="margin-top: 45px; margin-bottom: 40px;">
        ...
        <div class="why-us-grid">
          <div class="why-us-card">
            ...
            <h4 class="why-us-title">${r.eta} Varış Süresi</h4>
    ...
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <ul class="footer-links">
            <li><strong style="color: #fff;">Telefon:</strong> <a href="tel:05441380734">0544 138 07 34</a></li>
            <li><strong style="color: #fff;">WhatsApp:</strong> <a href="https://wa.me/905441380734">0544 138 07 34</a></li>
            <li><strong style="color: #fff;">Hizmet:</strong> 7/24 Kesintisiz</li>
            <li><strong style="color: #fff;">Konum:</strong> Ümraniye & Tüm Anadolu Yakası</li>
            <li><a href="../iletisim.html" style="color: var(--primary); font-weight: 700;">İletişim & Harita Sayfası →</a></li>
          </ul>
        </div>
      </div>

      <div class="footer-bottom">
        <p>&copy; 2026 Ümraniye Yol Yardım (umraniyeyolyardim.com) - Tüm Hakları Saklıdır.</p>
        <p>İstanbul Anadolu Yakası 7/24 Nöbetçi Oto Çekici ve Yol Yardım Hizmetleri</p>
      </div>
    </div>
  </footer>
  ...
  <div class="mobile-sticky-bar">
    <a href="tel:05441380734" class="btn btn-call">
      <span class="svg-icon" style="width:18px;height:18px;"><svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.02-.24 11.72 11.72 0 003.68.59 1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1 11.72 11.72 0 00.59 3.68 1 1 0 01-.24 1.02l-2.23 2.09z"/></svg></span> Hemen Ara
    </a>
    <a href="#" class="btn btn-whatsapp btn-send-location">
      <span class="svg-icon" style="width:18px;height:18px;"><svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.82 9.82 0 0012.04 2m.01 1.67c2.2 0 4.26.86 5.82 2.42a8.23 8.23 0 012.41 5.83c0 4.54-3.7 8.24-8.24 8.24-1.48 0-2.93-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.19 8.19 0 01-1.26-4.38c0-4.54 3.7-8.24 8.24-8.24m4.52 11.66c-.25-.13-1.47-.72-1.7-.81-.23-.08-.39-.13-.56.13-.17.25-.64.81-.79.97-.14.17-.29.19-.54.06-.25-.13-1.06-.39-2.01-1.24-.74-.66-1.25-1.48-1.39-1.73-.14-.25-.02-.39.11-.51.11-.11.25-.29.37-.44.13-.14.17-.25.25-.42.08-.17.04-.31-.02-.44-.06-.13-.56-1.34-.76-1.84-.2-.48-.4-.42-.56-.43h-.47c-.17 0-.44.06-.67.31-.23.25-.88.86-.88 2.1 0 1.24.9 2.44 1.03 2.61.13.17 1.77 2.7 4.29 3.79.6.26 1.07.41 1.43.53.6.19 1.15.16 1.58.1.48-.07 1.47-.6 1.68-1.18.21-.58.21-1.08.15-1.18-.06-.1-.23-.16-.48-.28z"/></svg></span> Konum At
    </a>
  </div>
...
regionsData.forEach(r => {
  const filePath = path.join(bolgelerDir, `${r.slug}.html`);
  const html = generateCompleteRegionPage(r);
  fs.writeFileSync(filePath, html, 'utf8');
  count++;
  console.log(`[${count}/24] Generated rich region: ${r.slug}.html`);
});

console.log('Successfully generated all 24 rich region pages with dual-photo showcases, schemas, and luxury neighbor cards!');
